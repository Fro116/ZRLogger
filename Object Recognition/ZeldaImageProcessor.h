...
class ZeldaImageProcessor {
 ...
 private:
  ...
  double CAPTURED_LEFT_DUNGEON_SIMILARITY_THRESHOLD = 0.80;
  ...
  double CAPTURED_RIGHT_DUNGEON_SIMILARITY_THRESHOLD = 0.80;
  ...
  double CAPTURED_TOP_DUNGEON_SIMILARITY_THRESHOLD = 0.80;
  ...
  double CAPTURED_BOTTOM_DUNGEON_SIMILARITY_THRESHOLD = 0.80;
};
